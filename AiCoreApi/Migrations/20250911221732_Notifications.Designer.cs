...
{
    [DbContext(typeof(Db))]
    [Migration("20250911221732_Notifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.EvaluationHistoryModel", b =>
                {
                    b.Property<int>("EvaluationHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("evaluation_history_id");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("EvaluationHistoryId"));
                    ...
                    b.Property<string>("EvaluationLlmModel")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("evaluation_llm_model");

                    b.Property<string>("EvaluationPrompt")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("evaluation_prompt");

                    b.Property<List<EvaluationHistoryQuestionModel>>("Questions")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.HasKey("EvaluationHistoryId")
                        .HasName("pk_evaluation_history");

                    b.ToTable("evaluation_history");
                });

            modelBuilder.Entity("AiCoreApi.Models.DbModels.EvaluationModel", b =>
                {
                    b.Property<int>("EvaluationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<List<EvaluationQuestionModel>>("Questions")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("questions");
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.LoginModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LoginId = 1,
                            Created = new DateTime(2025, 9, 11, 22, 17, 32, 104, DateTimeKind.Utc).AddTicks(5418),
                            CreatedBy = "system",
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.NotificationModel", b =>
                {
            ...
            modelBuilder.Entity("AiCoreApi.Models.DbModels.TaskModel", b =>
                {
                    ...
                    b.Property<int?>("LockerTaskId")
                        .HasColumnType("integer")
                        .HasColumnName("locker_task_id");
